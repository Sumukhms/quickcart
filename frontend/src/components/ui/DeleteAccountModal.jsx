...
export default function DeleteAccountModal({
  ...
  const isValid =
    confirmation === "DELETE" && (isGoogleOnly || password.length >= 1);
      ...
      >
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          >
            ...
            <ul
              className="text-xs space-y-1.5 pl-5"
              style={{ color: "var(--text-secondary)" }}
            >
              <li className="list-disc">
                Your profile, email and personal data
              </li>
              <li className="list-disc">All saved addresses and preferences</li>
              <li className="list-disc">Order history and ratings</li>
              {user?.role === "store" && (
                <li className="list-disc" style={{ color: "#f59e0b" }}>
                  Your store profile will be deleted (order records remain for
                  audit)
                </li>
              )}
              <li className="list-disc">
                Active orders will be cancelled automatically
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <input
              ...
              style={{
                borderColor:
                  confirmation === "DELETE" ? "rgba(239,68,68,0.5)" : undefined,
              }}
            />
          </div>

...
const NAV_LINKS = {
  ...
  store: [
    { to: "/user/home",       icon: Home,          label: "Shop" },      // ← ADD
          ...
          <div className="flex items-center gap-3 h-16">
            ...
            >
              <div className="relative">
                ...
                <div
                  className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-green-500 border-2 animate-pulse"
            ...
            <div className="flex items-center gap-1 ml-auto">
              ...
              {isLoggedIn && (
                ...
                >
                  ...
                  {count > 0 && (
                    <span
                      className="absolute -top-1 -right-1 min-w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold text-white"
              ...
              {isLoggedIn ? (
                <div className="relative" ref={userMenuRef}>
                  ...
                  {userMenuOpen && (
                    <div
                      className="absolute right-0 top-full mt-2 w-56 rounded-2xl overflow-hidden shadow-2xl border py-1 z-50"
                      style={{

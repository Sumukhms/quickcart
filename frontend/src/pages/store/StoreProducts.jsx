...
const DEMO_PRODUCTS = [
  ...
  },
  {
    ...
    image: "",
    storeId: "demo_store_food",
    description: "Slow-cooked chicken biryani with fragrant spices",
  },
  {
    _id: "dp5",
    name: "Dal Makhani",
    ...
    image: "",
    storeId: "demo_store_food",
    description: "Slow-cooked black lentils in rich butter gravy",
  },
  {
    _id: "dp6",
    name: "Gulab Jamun",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!err.response) {
        const mockSaved = {
          ...form,
          _id: product?._id || `demo_${Date.now()}`,
          price: Number(form.price),
          storeId: store._id,
        };
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              >
                {product
                  ? `Edit ${isFood ? "Dish" : "Product"}`
                  : `Add ${isFood ? "New Dish" : "New Product"}`}
              </h3>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder={
                isFood
                  ? "e.g. Butter Chicken, Masala Dosa, Veg Biryani"
                  : "e.g. Amul Milk 500ml"
              }
              value={form.name}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={
                isFood
                  ? "Ingredients, cooking style, serving info..."
          ...
          <ImageUploader
            type="product"
            entityId={product?._id} // undefined for new products
          ...
          <div
            className={`grid gap-3 ${!isFood ? "grid-cols-2" : "grid-cols-1"}`}
          >
            {!isFood && (
              <div>
                <label
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 py-6 pb-20">
        ...
        {isDemoMode && (
          <div
            className="rounded-xl p-3.5 mb-5 flex items-center gap-3 text-sm"
            style={{
          ...
          >
            ...
            <span className="flex-1">
              Demo mode — backend not connected. Changes won't be saved.
            </span>
          </div>
        )}
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm" style={{ color: "var(--text-muted)" }}>
              {store?.name} · {stats.total} {isFood ? "dishes" : "items"} ·{" "}
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 mb-5 scrollbar-hide">
            {allCats.map((cat) => (
              <button
                ...
                style={{
                  background:
                    catFilter === cat ? "var(--brand)" : "var(--elevated)",
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            {!search && (
              ...
              >
                <Plus size={14} />{" "}
                {isFood ? "Add Your First Dish" : "Add First Product"}
              </button>
            )}
          </div>
        ) : (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap mt-0.5">
                      ...
                      {isFood &&
                        product.spiceLevel &&
                        spiceColors[product.spiceLevel] && (
                          <span
                            className="text-[10px] px-1.5 py-0.5 rounded-md font-semibold"
                            style={{
                              background:
                                spiceColors[product.spiceLevel] + "15",
                              color: spiceColors[product.spiceLevel],
                            }}
                          >

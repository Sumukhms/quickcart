    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {isLow && (
            <span
              className="tag text-[10px] flex items-center gap-1"
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <Link to="/store/settings" className="btn btn-brand mt-4 text-sm">
            Create Store
          </Link>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm" style={{ color: "var(--text-muted)" }}>
              ...
              {!isFood && ` · ${stats.lowStock} low · ${stats.outOfStock} out`}
            </p>
          </div>
          <div className="flex items-center gap-2">
            {!isFood && (
                ...
                <div className="space-y-2">
                  {prods.map((product) =>
                    bulkMode && !isFood ? (
                      ...
                      >
                        <div
                          className="w-10 h-10 rounded-xl flex-shrink-0 overflow-hidden flex items-center justify-center text-xl"
                          style={{ background: "var(--elevated)" }}
                        >
                          {product.image ? (
                            <img
                        ...
                        <input
                          ...
                          style={{
                            background:
                              bulkEdits[product._id] !== undefined
        ...
        {!isFood && !bulkMode && (
          ...
          >
            ...
            {[
              ...
              {
                dot: "#f59e0b",
                text: `Stock 1–${threshold} — Low stock warning`,
              },

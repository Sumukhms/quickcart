 ...
 *   2. Favorites filter button: toggle to show only saved stores
 *   3. Product search results link to the store page with the product visible
 */
          ...
          <section className="py-3">
            ...
            <div className="flex gap-2 mb-4">
              <button
                ...
                style={{
                  background:
                    searchTab === "stores" ? "var(--brand)" : "var(--elevated)",
              ...
              <button
                ...
                style={{
                  background:
                    searchTab === "items" ? "var(--brand)" : "var(--elevated)",

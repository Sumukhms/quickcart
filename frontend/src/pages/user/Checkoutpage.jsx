...
export default function CheckoutPage() {
  ...
  const grandTotal = Math.max(
    ...
    total +
      effectiveDelivery -
      (appliedCoupon?.freeDelivery ? 0 : couponDiscount),
  );
              ...
              >
                ...
                >
                  <MapPin
                    size={15}
                    style={{
                      color: step === 1 ? "var(--brand)" : "var(--text-muted)",
                    }}
                  />
                </div>
                  ...
                  <div className="space-y-2 mb-4 max-h-48 overflow-y-auto">
                    {cartItems.map((item) => (
                      <div key={item._id} className="flex items-center gap-3">
                        <div
                          className="w-8 h-8 rounded-lg overflow-hidden flex-shrink-0 img-fallback text-sm"
                          style={{ background: "var(--elevated)" }}
                        >
                          {item.image ? (
                            <img
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            ...
            >
              ...
              >
                ...
                <div
                  className="flex justify-between items-center pt-3 mt-1 font-bold text-base"
                  style={{ borderTop: "1px solid var(--border)" }}
                >
                  <span style={{ color: "var(--text-primary)" }}>Total</span>
                  <span style={{ color: "var(--brand)", fontSize: "1.2rem" }}>
                    ₹{grandTotal.toFixed(0)}
                  </span>
                </div>
              </div>
              ...
              {appliedCoupon || couponDiscount > 0 ? (
                <div
                  className="mx-4 mb-4 px-4 py-2.5 rounded-xl flex items-center gap-2 text-xs font-semibold"
                  style={{
                    background: "rgba(34,197,94,0.08)",
                    color: "#22c55e",
                  }}
                ...
                <div
                  className="mx-4 mb-4 px-4 py-2.5 rounded-xl text-xs font-medium"
                  style={{
                    background: "var(--elevated)",
                    color: "var(--text-muted)",
                  }}

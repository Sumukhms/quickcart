  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover":
          "0 10px 24px rgba(0,0,0,0.08), 0 4px 8px rgba(0,0,0,0.04)",
      ...
      animation: {
        ...
        "toast-in": "toastIn 0.2s cubic-bezier(0.16,1,0.3,1) both",
        "badge-bounce": "badgeBounce 0.3s ease",
